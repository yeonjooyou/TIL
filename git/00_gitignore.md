...
* 일반적으로 `OS(운영체제 - mac, windows)` , 특정 언어, 특정 개발 환경(파이참, vs code, eclipse, ...)
  ...
  * https://gitignore.io
    ...
    ![image-20210706180517942](md-images/image-20210706180517942.png)
...
![image-20210706191052172](md-images/image-20210706191052172.png)

![image-20210706191104994](md-images/image-20210706191104994.png)
